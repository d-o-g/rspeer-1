...
import org.objectweb.asm.commons.Digraph;
import org.objectweb.asm.commons.cfg.optimizer.Optimizer;
...
public class FlowVisitor extends MethodVisitor {
    ...
    public void visitEnd() {
        ...
        List<Block> flattened = Optimizer.flatten(mn, blocks);
        blocks.clear();
        blocks.addAll(flattened);
