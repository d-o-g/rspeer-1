...
public final class Time {
    ...
    /**
     * <p>This sleep will sleep until the passed condition is true for your amount of duration.
     * Useful for scenarios where you want to make sure a condition holds for a specific amount of
     * time before stopping sleeping.</p>
     * <p>
     * <p>Calls {@link Time#sleepUntil(BooleanSupplier, BooleanSupplier, long, long)} with a threshold of 50</p>
     *
    ...
    public static boolean sleepWhile(BooleanSupplier condition, BooleanSupplier reset, long threshold, long timeout) {
        return sleepUntil(() -> !condition.getAsBoolean(), reset, threshold, timeout);
    }

    public static boolean sleepWhile(BooleanSupplier condition, BooleanSupplier reset, long timeout) {
        return sleepWhile(condition, reset, defaultThreshold, timeout);
    }
