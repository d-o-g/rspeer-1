 ...
 */
public final class LoginResponseEvent extends Event {

    private final Response response;

    public LoginResponseEvent(int code) {
        super("Static");
        response = Response.forCode(code);
    }
    ...
    public enum Response {
        ...
        ERROR_CONNECTING(-2, "", "Error connecting to server.", ""),
        ...
        ACCOUNT_DISABLED(4, "Your account has been disabled.", "Please check your message-centre for details.", ""),
        ...
        Response(int code, String line1, String line2, String line3) {
            this.code = code;
            this.line1 = line1;
            this.line2 = line2;
            this.line3 = line3;
        ...
        public static Response forMessage(String contained) {
            for (Response response : Response.values()) {
                if (response.getMessage().toLowerCase().contains(contained.toLowerCase())) {
                    return response;
                }
            }
            return null;
