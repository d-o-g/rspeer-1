...
public class AccountManager extends JPanel {
    ...
    public AccountManager() {
        ...
        ImageIcon[] plusIcons = SwingResources.loadButtonImages(RSPeer.class.getResourceAsStream("/org/rspeer/ui/account/green-plus.png"), 17, 17, .6f);
        ...
        ImageIcon[] minusIcons = SwingResources.loadButtonImages(RSPeer.class.getResourceAsStream("/org/rspeer/ui/account/red-minus.png"), 17, 17, .6f);
        ...
        ImageIcon[] clipboardIcons = SwingResources.loadButtonImages(RSPeer.class.getResourceAsStream("/org/rspeer/ui/account/clipboard.png"), 17, 17, .6f);
