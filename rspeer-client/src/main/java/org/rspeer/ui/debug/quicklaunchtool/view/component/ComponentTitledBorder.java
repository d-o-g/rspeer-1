package org.rspeer.ui.debug.quicklaunchtool.view.component;
...
public class ComponentTitledBorder implements Border, MouseListener, MouseMotionListener, SwingConstants {
    ...
    private void dispatchEvent(MouseEvent me, int id) {
        ...
        comp.dispatchEvent(new MouseEvent(comp, id, me.getWhen(), me.getModifiers(), pt.x, pt.y, me.getClickCount(),
