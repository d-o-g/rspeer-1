...
public class RsPeerExecutor {
    ...
    public static void executeWitRetry(CheckedRunnable runnable) {
        executor.execute(executeWithRetry(runnable, DEFAULT_THROWABLE_CONSUMER));
    }

    public static void executeWitRetry(CheckedRunnable runnable, int tries) {
